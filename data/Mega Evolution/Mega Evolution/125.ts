...
const card: Card = {
	...
	effect: {
		...
		it: "Scegli uno dei tuoi Pokémon Base in gioco. Se hai in mano una carta di Fase 2 che si evolve da quel Pokémon, mettila sopra il Pokémon Base per farlo evolvere, saltando la Fase 1. Non puoi usare questa carta durante il tuo primo turno o su un Pokémon Base che hai messo in gioco nel turno in corso.",
		es: "Elige 1 de tus Pokémon Básicos en juego. Si tienes en tu mano una carta de Fase 2 que evolucione de ese Pokémon, pon esa carta sobre el Pokémon Básico para hacerlo evolucionar, saltándote la Fase 1. No puedes usar esta carta durante tu primer turno ni sobre un Pokémon Básico que se haya puesto en juego en este turno.",
		...
		'es-mx': "Elige 1 de tus Pokémon Básicos en juego. Si tienes en tu mano una carta de Fase 2 que evolucione de ese Pokémon, pon esa carta sobre el Pokémon Básico para hacerlo evolucionar, saltando la Fase 1. No puedes usar esta carta durante tu primer turno ni sobre un Pokémon Básico que se haya puesto en juego en este turno."
	},
