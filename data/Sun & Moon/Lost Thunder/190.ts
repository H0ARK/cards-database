...
const card: Card = {
	...
	effect: {
		...
		en: "When the Psychic Pokémon this card is attached to is Knocked Out by damage from an opponent’s attack, put 4 damage counters on your opponent’s Pokémon in any way you like.",
