...
const card: Card = {
	...
	effect: {
		...
		en: "The Pokémon this card is attached to takes 30 less damage from the attacks of your opponent’s Pokémon-GX and Pokémon-EX (after applying Weakness and Resistance).",
