...
const card: Card = {
	...
	effect: {
		...
		it: "Gli attacchi dei Pokémon che non sono Ultracreature e hanno delle Energie base Fighting assegnate, sia tuoi che del tuo avversario, infliggono 10 danni in più al Pokémon attivo dell’avversario, prima di applicare debolezza e resistenza. Se il giocatore che sta attaccando ha più carte Premio rimanenti del proprio avversario, quegli attacchi infliggono invece 40 danni in più.",
