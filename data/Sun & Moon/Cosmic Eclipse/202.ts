...
const card: Card = {
	...
	effect: {
		...
		en: "Search your deck for a Pokémon-GX that evolves from 1 of your Pokémon and put it onto that Pokémon to evolve it. Then, shuffle your deck. (You can’t use this card during your first turn or on a Pokémon that was put into play this turn.)\n\nWhen you play this card, you may discard 2 other cards from your hand. If you do, search your deck for up to 2 basic Energy cards and attach them to the Pokémon you evolved in this way.",
		es: "Busca en tu baraja 1 Pokémon-GX que evolucione de 1 de tus Pokémon y ponlo sobre ese Pokémon para hacerlo evolucionar. Después, baraja las cartas de tu baraja. (No puedes usar esta carta durante tu primer turno o sobre un Pokémon que se haya puesto en juego en este turno).\n\nCuando juegues esta carta, puedes descartar otras 2 cartas de tu mano. Si lo haces, busca en tu baraja hasta 2 cartas de Energía Básica y únelas al Pokémon que hayas hecho evolucionar de esta manera.",
		it: "Cerca nel tuo mazzo un Pokémon-GX che si evolve da uno dei tuoi Pokémon e mettilo sopra quel Pokémon per farlo evolvere. Poi rimischia le carte del tuo mazzo. Non puoi usare questa carta durante il tuo primo turno o su un Pokémon che hai messo in gioco nel turno in corso.\n\nQuando giochi questa carta, puoi scartare altre due carte che hai in mano. Se lo fai, cerca nel tuo mazzo fino a due carte Energia base e assegnale al Pokémon che hai fatto evolvere in questo modo.",
