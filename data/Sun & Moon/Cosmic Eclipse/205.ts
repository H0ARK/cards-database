...
const card: Card = {
	...
	effect: {
		...
		es: "Descarta hasta 2 Pokémon que no sean Pokémon-GX o Pokémon-EX de tu mano. Roba 3 cartas por cada carta que hayas descartado de esta manera.",
		it: "Scarta fino a due Pokémon che hai in mano e che non siano Pokémon-GX o Pokémon-EX. Pesca tre carte per ogni carta che hai scartato in questo modo.",
