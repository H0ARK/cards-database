...
const card: Card = {
	...
	effect: {
		...
		pt: "Procure por até 3 cartas de Energia Water no seu baralho, revele-as e coloque-as na sua mão. Em seguida, embaralhe o seu baralho.\n\nQuando você joga esta carta, você pode descartar outras 5 cartas da sua mão. Se fizer isto, durante esta vez de jogar, seus Pokémon Water podem usar seus ataques GX mesmo se você já tiver usado um ataque GX.",
		de: "Durchsuche dein Deck nach bis zu 3 Water-Energiekarten, zeige sie deinem Gegner und nimm sie auf deine Hand. Mische anschließend dein Deck.\n\nWenn du diese Karte spielst, kannst du 5 andere Karten aus deiner Hand auf deinen Ablagestapel legen. Wenn du das machst, können deine Water-Pokémon während dieses Zuges ihre GX-Attacken einsetzen, auch wenn du deine GX-Attacke eingesetzt hast."
	},
