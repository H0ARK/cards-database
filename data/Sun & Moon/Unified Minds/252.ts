...
const card: Card = {
	...
	effect: {
		en: "If you have more Prize cards remaining than your opponent, the attacks of the Pokémon this card is attached to cost Fighting less.",
