...
const card: Card = {
	name: {
		...
		es: "Aerostal Z: Tajo Aéreo",
		it: "Volantium Z: Eterelama",
	...
	effect: {
		...
		en: "If the Pokémon this card is attached to has the Air Slash attack, it can use the GX attack on this card. (You still need the necessary Energy to use this attack.)\n\nColorlessColorlessColorlessColorless Speeding Skystrike GX 180\nPrevent all effects of attacks, including damage, done to this Pokémon during your opponent’s next turn. (You can’t use more than 1 GX attack in a game.)",
		es: "Si el Pokémon al que está unida esta carta tiene el ataque Tajo Aéreo, puede usar el ataque GX de esta carta. (Sigues necesitando la Energía necesaria para usar este ataque).\n\nColorlessColorlessColorlessColorless Picado Acelerado GX 180\nEvita todos los efectos de los ataques, incluido el daño, infligidos a este Pokémon durante el próximo turno de tu rival. (No puedes usar más de 1 ataque GX en una partida).",
		it: "Se il Pokémon a cui è assegnata questa carta ha l’attacco Eterelama, può usare l’attacco GX di questa carta. Devi comunque avere l’Energia necessaria per usare questo attacco.\n\nColorlessColorlessColorlessColorless Picchiata Sfrecciante GX 180\nPrevieni tutti gli effetti degli attacchi, inclusi i danni, inflitti a questo Pokémon durante il prossimo turno del tuo avversario. Non puoi usare più di un attacco GX a partita.",
