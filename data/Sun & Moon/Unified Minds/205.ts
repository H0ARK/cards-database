...
const card: Card = {
	...
	effect: {
		...
		es: "Una vez durante el turno de cada jugador, ese jugador puede buscar en su baraja hasta 2 Pokémon que evolucionen de Fósil Desconocido, poner esos Pokémon en su Banca y barajar las cartas de su baraja. Si un jugador hace búsquedas en su baraja de esta manera, su turno termina.",
		it: "Una sola volta durante il turno di ciascun giocatore, quel giocatore può cercare nel suo mazzo fino a due Pokémon che si evolvono da Fossile Sconosciuto, metterli nella sua panchina e rimischiare le carte del suo mazzo. Se un giocatore cerca nel suo mazzo in questo modo, il suo turno finisce.",
