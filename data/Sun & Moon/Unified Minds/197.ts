...
const card: Card = {
	...
	effect: {
		...
		en: "Once during each player’s turn, that player may discard a card from their hand. If they do, that player searches their deck for up to 2 Fire Energy cards, reveals them, and puts them into their hand. Then, that player shuffles their deck.",
		es: "Una vez durante el turno de cada jugador, ese jugador puede descartar 1 carta de su mano. Si lo hace, ese jugador busca en su baraja hasta 2 cartas de Energía Fire, las enseña y las pone en su mano. Después, ese jugador baraja las cartas de su baraja.",
		it: "Una sola volta durante il turno di ciascun giocatore, quel giocatore può scartare una carta che ha in mano. Se lo fa, quel giocatore cerca nel suo mazzo fino a due carte Energia Fire, le mostra e le aggiunge alle carte che ha in mano. Poi quel giocatore rimischia le carte del suo mazzo.",
