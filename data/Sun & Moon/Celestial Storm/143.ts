...
const card: Card = {
	...
	effect: {
		...
		en: "Between turns, put 1 damage counter on each Pokémon-GX and Pokémon-EX (both yours and your opponent’s).",
		es: "Entre turnos, pon 1 contador de daño en cada Pokémon-GX y Pokémon-EX (tanto tuyos como de tu rival).",
		it: "Tra un turno e l’altro, metti un segnalino danno su tutti i Pokémon-GX e i Pokémon-EX, sia tuoi che del tuo avversario.",
