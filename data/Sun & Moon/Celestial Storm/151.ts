...
const card: Card = {
	...
	effect: {
		...
		it: "Questa carta fornisce Energia Colorless. Fintanto che è in gioco, fornisce Energia di qualsiasi tipo, ma solo una alla volta. Quando assegni questa carta dalla tua mano a uno dei tuoi Pokémon, metti un segnalino danno su quel Pokémon.",
