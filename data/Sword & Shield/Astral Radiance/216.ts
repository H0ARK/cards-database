...
const card: Card = {
	...
	effect: {
		en: "As long as this card is attached to a Pokémon, it provides ColorlessColorless Energy.\nThe attacks of the Pokémon this card is attached to do 20 less damage to your opponent's Pokémon (before applying Weakness and Resistance).",
		fr: "Tant que cette carte est attachée à un Pokémon, elle fournit de l'Énergie ColorlessColorless.\nLes attaques du Pokémon auquel cette carte est attachée infligent 20 dégâts de moins aux Pokémon de votre adversaire (avant application de la Faiblesse et de la Résistance).",
		es: "Mientras esta carta esté unida a 1 Pokémon, proporciona 2 Energías Colorless.\nLos ataques del Pokémon al que esté unida esta carta hacen 20 puntos de daño menos a los Pokémon de tu rival (antes de aplicar Debilidad y Resistencia).",
