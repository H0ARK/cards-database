...
const card: Card = {
	...
	effect: {
		...
		es: "Cuando tu Pokémon Activo quede Fuera de Combate por el daño de un ataque de tu rival, puedes mover 1 carta de Energía Básica que estuviera unida a ese Pokémon al Pokémon al que esté unida esta carta.",
		...
		pt: "Quando seu Pokémon Ativo for Nocauteado pelos danos causados por um ataque do oponente, você poderá mover 1 card de Energia básica que estava ligado àquele Pokémon para o Pokémon ao qual\nesse card está ligado.",
