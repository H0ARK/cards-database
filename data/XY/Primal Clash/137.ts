...
const card: Card = {
	...
	effect: {
		...
		en: "Once during each player's turn, that player may heal 30 damage from each of his or her Water Pokémon and Lightning Pokémon.",
		es: "Una vez durante el turno de cada jugador, ese jugador puede curar 30 puntos de daño a cada uno de sus Pokémon Water y Pokémon Lightning.",
		it: "Una sola volta durante il turno di ciascun giocatore, quel giocatore può curare 30 danni da ciascuno dei suoi Pokémon Water e Lightning.",
