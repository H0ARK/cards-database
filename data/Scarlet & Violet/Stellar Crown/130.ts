...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			en: "As long as this Pokémon is in the Active Spot, attacks used by your opponent's Basic Pokémon cost {C} more.",
			fr: "Tant que ce Pokémon est sur le Poste Actif, les attaques utilisées par les Pokémon de base de votre adversaire coûtent {C} de plus.",
			es: "Mientras este Pokémon esté en el Puesto Activo, los ataques usados por los Pokémon Básicos de tu rival cuestan {C} más.",
			it: "Fintanto che questo Pokémon è in posizione attiva, il costo degli attacchi usati dai Pokémon Base del tuo avversario aumenta di {C}.",
			pt: "Enquanto este Pokémon estiver no Campo Ativo, os ataques usados pelos Pokémon Básicos do seu oponente custarão {C} a mais.",
			de: "Solange dieses Pokémon in der Aktiven Position ist, erhöhen sich die Kosten der von Basis-Pokémon deines Gegners eingesetzten Attacken um {C}."
		}
	}],
