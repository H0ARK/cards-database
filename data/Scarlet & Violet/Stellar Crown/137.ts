...
const card: Card = {
	...
	name: {
		...
		fr: "Gemme Gravité",
		es: "Gema Gravedad",
		it: "Gemma Gravitazionale",
		pt: "Gema da Gravidade",
		de: "Erdanziehungsedelstein"
	},
	...
	effect: {
		en: "As long as the Pokémon this card is attached to is in the Active Spot, the Retreat Cost of both Active Pokémon is {C} more.",
		fr: "Tant que le Pokémon auquel cette carte est attachée est sur le Poste Actif, le Coût de Retraite des deux Pokémon Actifs est augmenté de {C}.",
