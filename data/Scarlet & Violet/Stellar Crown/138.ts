...
const card: Card = {
	...
	effect: {
		en: "Put 2 cards from your hand on the bottom of your deck in any order. If you put 2 cards on the bottom of your deck in this way, draw 4 cards. (If you can't put 2 cards from your hand on the bottom of your deck, you can't use this card.)",
		fr: "Placez 2 cartes de votre main en dessous de votre deck dans l'ordre de votre choix. Si vous avez placé 2 cartes en dessous de votre deck de cette façon, piochez 4 cartes. (Si vous ne pouvez pas placer 2 cartes de votre main en dessous de votre deck, vous ne pouvez pas utiliser cette carte.)",
