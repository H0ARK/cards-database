...
const card: Card = {
	...
	name: {
		...
		es: "Mirada de Yasmina",
		it: "Sguardo di Jasmine",
		pt: "Olhar da Jasmine",
		de: "Jasmins Blick"
	},
	...
	effect: {
		en: "During your opponent's next turn, all of your Pokémon take 30 less damage from attacks from your opponent's Pokémon (after applying Weakness and Resistance). (This includes new Pokémon that come into play.)",
		fr: "Pendant le prochain tour de votre adversaire, tous vos Pokémon subissent 30 dégâts de moins provenant des attaques des Pokémon de votre adversaire (après application de la Faiblesse et de la Résistance). (Cela comprend les nouveaux Pokémon qui sont mis en jeu.)",
