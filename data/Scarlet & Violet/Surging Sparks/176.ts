...
const card: Card = {
	...
	name: {
		en: "Energy Search Pro",
		fr: "Recherche d'Énergie Pro",
		es: "Búsqueda de Energía Pro",
		it: "Ricerca di Energia Pro",
		pt: "Busca de Energia Profissional",
		de: "Profi-Energiesuche"
	},
	...
	effect: {
		en: "Search your deck for any number of Basic Energy cards of different types, reveal them, and put them into your hand. Then, shuffle your deck.",
		fr: "Cherchez dans votre deck le nombre voulu de cartes Énergie de base de types différents, montrez-les, puis ajoutez-les à votre main. Mélangez ensuite votre deck.",
