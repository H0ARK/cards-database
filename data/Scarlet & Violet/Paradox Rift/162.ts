...
const card: Card = {
	...
	effect: {
		en: "If you have more Prize cards remaining than your opponent, the Pokémon this card is attached to takes 40 less damage from attacks from your opponent's Pokémon (after applying Weakness and Resistance).",
		fr: "S'il vous reste plus de cartes Récompense qu'à votre adversaire, le Pokémon auquel cette carte est attachée subit 40 dégâts de moins provenant des attaques des Pokémon de votre adversaire (après application de la Faiblesse et de la Résistance).",
