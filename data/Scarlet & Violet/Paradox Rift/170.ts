...
const card: Card = {
	...
	name: {
		...
		es: "Vitalidad de la Profesora Albora",
		it: "Vitalità della Professoressa Olim",
		pt: "Vitalidade da Professora Arka",
		de: "Prof. Antiquas Vitalität"
	},
	...
	effect: {
		en: "Choose up to 2 of your Ancient Pokémon and attach a Basic Energy card from your discard pile to each of them. If you attached any Energy in this way, draw 3 cards.",
		fr: "Choisissez jusqu'à 2 de vos Pokémon Temps passé et attachez une carte Énergie de base de votre pile de défausse à chacun d'eux. Si vous avez attaché au moins une Énergie de cette façon, piochez 3 cartes.",
