...
const card: Card = {
	...
	name: {
		...
		fr: "Plumeau Maudit",
		es: "Plumero Maldito",
		it: "Spolverino Maledetto",
		pt: "Espanador Amaldiçoado",
		de: "Verfluchter Staubwedel"
	},
	...
	effect: {
		en: "If the Pokémon this card is attached to is Knocked Out by damage from an attack from your opponent's Pokémon, discard a random card from your opponent's hand.",
		fr: "Si le Pokémon auquel cette carte est attachée est mis K.O. par les dégâts d'une attaque de l'un des Pokémon de votre adversaire, défaussez au hasard une carte de la main de votre adversaire.",
