...
const card: Card = {
	...
	name: {
		...
		fr: "Cape Luxueuse",
		es: "Capa Suntuosa",
		it: "Mantello Sfarzoso",
		pt: "Capa Luxuosa",
		de: "Luxuriöser Umhang"
	},
	...
	effect: {
		en: "If the Pokémon this card is attached to doesn't have a Rule Box, it gets +100 HP, and if it is Knocked Out by damage from an attack from your opponent's Pokémon, that player takes 1 more Prize card. (Pokémon ex, Pokémon V, etc. have Rule Boxes.)",
		fr: "Si le Pokémon auquel cette carte est attachée n'a pas d'encadré Règle, il reçoit +100 PV. S'il est mis K.O. par les dégâts d'une attaque de l'un des Pokémon de votre adversaire, ce dernier récupère une carte Récompense supplémentaire. (Les Pokémon-ex, Pokémon-V, etc. ont des encadrés Règle.)",
