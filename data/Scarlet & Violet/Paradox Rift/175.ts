...
const card: Card = {
	...
	effect: {
		en: "If this card is in your hand when you are setting up to play, you may put it face down in the Active Spot or on your Bench as if it were a 120-HP Basic {C} Pokémon. (You can do this only when you are setting up to play.) At any time during your turn, you may discard this card from play.\n\nThis card can't be affected by any Special Conditions and can't retreat. If this card is Knocked Out, your opponent can't take any Prize cards for it.",
		...
		es: "Si esta carta está en tu mano cuando te estás preparando para jugar, puedes ponerla boca abajo en el Puesto Activo o en tu Banca como si fuera un Pokémon {C} Básico de 120 PS. (Puedes hacer esto solo cuando te estés preparando para jugar). En cualquier momento durante tu turno, puedes descartar esta carta del juego.\nEsta carta no puede verse afectada por ninguna Condición Especial y no puede retirarse. Si esta carta queda Fuera de Combate, tu rival no puede coger ninguna carta de Premio por ello.",
		it: "Se hai questa carta in mano durante l'allestimento del gioco, puoi metterla a faccia in giù in posizione attiva o in panchina come se fosse un Pokémon Base {C} con 120 PS. Puoi farlo solo durante l'allestimento del gioco. Durante il tuo turno, in qualsiasi momento, puoi scartare questa carta dal gioco.\n\nQuesta carta non può essere influenzata da condizioni speciali e non può ritirarsi. Se questa carta viene messa KO, il tuo avversario non può prendere carte Premio per effetto di quel KO.",
		...
		de: "Wenn diese Karte bei der Spielvorbereitung auf deiner Hand ist, kannst du sie verdeckt in die Aktive Position oder auf deine Bank legen, als ob sie ein Basis-{C}-Pokémon mit 120 KP wäre. (Du kannst dies nur bei der Spielvorbereitung machen.) Du kannst diese Karte jederzeit während deines Zuges aus dem Spiel nehmen und auf deinen Ablagestapel legen.\n\nDiese Karte kann von keinen Speziellen Zuständen betroffen werden und sich nicht zurückziehen. Wenn diese Karte kampfunfähig wird, kann dein Gegner dafür keine Preiskarten nehmen."
	},
