...
const card: Card = {
	...
	effect: {
		en: "Once during each player's turn, that player may flip a coin. If heads, that player searches their deck for a Pokémon, reveals it, and puts it into their hand. Then, that player shuffles their deck.",
		fr: "Une fois pendant le tour de chaque joueur, ce joueur-là peut lancer une pièce. Si c'est face, ce joueur cherche dans son deck un Pokémon, le montre, puis l'ajoute à sa main. Ce joueur mélange ensuite son deck.",
