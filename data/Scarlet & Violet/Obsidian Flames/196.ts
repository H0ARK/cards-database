...
const card: Card = {
	...
	effect: {
		fr: "Une fois pendant le tour de chaque joueur, ce joueur-là peut chercher dans son deck une carte Outil Pokémon, la montrer et l'ajouter à sa main. Ce joueur mélange ensuite son deck.",
		en: "Once during each player's turn, that player may search their deck for a Pokémon Tool card, reveal it, and put it into their hand. Then, that player shuffles their deck.",
