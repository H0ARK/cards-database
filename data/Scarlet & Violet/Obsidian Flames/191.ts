...
const card: Card = {
	...
	name: {
		fr: "Casquette de Patrouille",
		en: "Patrol Cap",
		es: "Gorra de Patrulla",
		it: "Berretto d'Ordinanza",
		pt: "Chapéu de Patrulha",
		de: "Patrouillenkappe"
	},
	...
	effect: {
		fr: "Tant que le Pokémon auquel cette carte est attachée est sur le Poste Actif, les cartes de votre deck ne peuvent pas être défaussées par les effets des attaques, talents, cartes Objet, cartes Outil Pokémon ou cartes Supporter de votre adversaire.",
		en: "As long as the Pokémon this card is attached to is in the Active Spot, cards in your deck can't be discarded by effects of your opponent's attacks, Abilities, Item cards, Pokémon Tool cards, or Supporter cards.",
