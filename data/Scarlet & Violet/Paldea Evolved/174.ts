...
const card: Card = {
	...
	name: {
		fr: "Montagne Enneigée de Désastre",
		en: "Calamitous Snowy Mountain",
		es: "Montaña Nevada Funesta",
		it: "Monte Nevoso della Disgrazia",
		pt: "Montanha Nevada Calamitosa",
		de: "Unheilvolles Schneegebirge"
	},
	...
	effect: {
		fr: "Chaque fois qu'un joueur attache une carte Énergie de sa main à l'un de ses Pokémon non-{W} de base, placez 2 marqueurs de dégâts sur ce Pokémon-là.",
		en: "Whenever any player attaches an Energy card from their hand to 1 of their Basic non-{W} Pokémon, put 2 damage counters on that Pokémon.",
