...
const card: Card = {
	...
	effect: {
		fr: "Piochez des cartes jusqu'à en avoir 5 en main. Si aucun de vos Pokémon n'a d'Énergies attachées, piochez des cartes jusqu'à en avoir 7 en main à la place.",
