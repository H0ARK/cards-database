...
const card: Card = {
	...
	effect: {
		en: "Each Pokémon that has any Energy attached (both yours and your opponent's) recovers from all Special Conditions and can't be affected by any Special Conditions.",
		fr: "Chacun des Pokémon auxquels au moins une Énergie est attachée (les vôtres et ceux de votre adversaire) guérit de tous les États Spéciaux et ne peut être affecté par aucun État Spécial.",
