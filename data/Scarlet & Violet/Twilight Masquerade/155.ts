...
const card: Card = {
	...
	name: {
		...
		es: "Ayuda de Nereida",
		it: "Soccorso di Suiren",
		pt: "Ajuda da Vitória",
		de: "Tracys Unterstützung"
	},
	...
	effect: {
		en: "Put up to 3 in any combination of Pokémon that don't have a Rule Box and Basic Energy cards from your discard pile into your hand. (Pokémon ex, Pokémon V, etc. have Rule Boxes.)",
		fr: "Ajoutez à votre main une combinaison d'un maximum de 3 Pokémon sans encadré Règle et cartes Énergie de base de votre pile de défausse. (Les Pokémon-ex, Pokémon-V, etc. ont des encadrés Règle.)",
