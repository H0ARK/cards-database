...
const card: Card = {
	...
	name: {
		en: "Ogre's Mask",
		fr: "Masque de Monstre",
		es: "Máscara del Ogro",
		it: "Maschera dell'Orco",
		pt: "Máscara do Ogro",
		de: "Maske des Oni"
	},
	...
	effect: {
		en: "Choose a Pokémon ex in your discard pile that has \"Ogerpon\" in its name, and switch it with 1 of your Pokémon ex in play that has \"Ogerpon\" in its name. Any attached cards, damage counters, Special Conditions, turns in play, and any other effects remain on the new Pokémon.",
		fr: "Choisissez un Pokémon-ex dans votre pile de défausse ayant \" Ogerpon \" dans son nom et échangez-le contre l'un de vos Pokémon-ex en jeu ayant \" Ogerpon \" dans son nom. Les cartes attachées, les marqueurs de dégâts, les États Spéciaux, le nombre de tours en jeu et tous les autres effets restent sur le nouveau Pokémon.",
