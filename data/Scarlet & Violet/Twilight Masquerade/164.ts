...
const card: Card = {
	...
	name: {
		en: "Survival Brace",
		fr: "Orthèse de Survie",
		es: "Brazal de Supervivencia",
		it: "Tutore di Sopravvivenza",
		pt: "Cinta de Sobrevivência",
		de: "Überlebensschiene"
	},
	...
	effect: {
		en: "If the Pokémon this card is attached to has full HP and would be Knocked Out by damage from an attack from your opponent's Pokémon, it is not Knocked Out, and its remaining HP becomes 10. Then, discard this card.",
		fr: "Si le Pokémon auquel cette carte est attachée a tous ses PV et doit être mis K.O. par les dégâts d'une attaque de l'un des Pokémon de votre adversaire, ce Pokémon n'est pas mis K.O. et il lui reste 10 PV. Défaussez ensuite cette carte.",
