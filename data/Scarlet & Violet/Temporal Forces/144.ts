...
const card: Card = {
	...
	name: {
		en: "Buddy-Buddy Poffin",
		fr: "Poffin Copain-Copain",
		es: "Pokochos Gemelos",
		it: "Poffin del Cuore",
		pt: "Poffin de Colega",
	...
	effect: {
		en: "Search your deck for up to 2 Basic Pokémon with 70 HP or less and put them onto your Bench. Then, shuffle your deck.",
		fr: "Cherchez dans votre deck jusqu'à 2 Pokémon de base ayant 70 PV ou moins et placez-les sur votre Banc. Mélangez ensuite votre deck.",
