...
const card: Card = {
	...
	effect: {
		en: "If the Pokémon this card is attached to has a Retreat Cost of exactly 4, is in the Active Spot, and is Knocked Out by damage from an attack from your opponent's Pokémon, move up to 3 Basic Energy cards from that Pokémon to your Benched Pokémon in any way you like.",
		fr: "Si le Pokémon auquel cette carte est attachée a un Coût de Retraite d'exactement 4, est sur le Poste Actif et est mis K.O. par les dégâts d'une attaque de l'un des Pokémon de votre adversaire, déplacez jusqu'à 3 cartes Énergie de base de ce Pokémon-là vers vos Pokémon de Banc comme il vous plaît.",
