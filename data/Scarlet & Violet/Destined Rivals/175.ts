...
const card: Card = {
	...
	name: {
		en: "Team Rocket's Great Ball",
		fr: "Super Ball de la Team Rocket",
	...
	effect: {
		en: "Flip a coin. If heads, search your deck for an Evolution Team Rocket's Pokémon, reveal it, and put it into your hand. If tails, search your deck for a Basic Team Rocket's Pokémon, reveal it, and put it into your hand. Then, shuffle your deck.",
		fr: "Lancez une pièce. Si c'est face, cherchez dans votre deck un Pokémon de la Team Rocket Évolutif, montrez-le, puis ajoutez-le à votre main. Si c'est pile, cherchez dans votre deck un Pokémon de la Team Rocket de base, montrez-le, puis ajoutez-le à votre main. Mélangez ensuite votre deck.",
