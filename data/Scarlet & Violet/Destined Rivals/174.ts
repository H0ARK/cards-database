...
const card: Card = {
	...
	effect: {
		...
		'es-mx': "Cambia tu Pokémon del Equipo Rocket Activo por 1 de tus Pokémon del Equipo Rocket en Banca. Si lo haces, cambia 1 de los Pokémon en Banca de tu rival por el Pokémon que esté en el Puesto Activo."
	},
